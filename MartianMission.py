...
pygame.mixer.music.load('music/audio_MMlevel5.mp3')
...
bomb_fx = pygame.mixer.Sound('music/audio_grenade.wav')
...
#load images
#background image
bg_img = pygame.image.load('img/pixelMars.png').convert_alpha()
...
for x in range(TILE_TYPES):
    img = pygame.image.load(f'img/Tiles/tile{x}.png')
    img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
    img_list.append(img)
#energy ball
ebullet_img = pygame.image.load('img/hsLaser.png').convert_alpha()
ebullet_img = pygame.transform.scale(ebullet_img, (40, 40))
#Alien bomb
laser_img = pygame.image.load('img/yelball.png').convert_alpha()
laser_img = pygame.transform.scale(laser_img, (30, 30))
#Item drops
health_drop_img = pygame.image.load('img/drops/health_drop.png').convert_alpha()
health_drop_img = pygame.transform.scale(health_drop_img, (80, 80))
energy_ammo_img = pygame.image.load('img/drops/energy_ammo.png').convert_alpha()
energy_ammo_img = pygame.transform.scale(energy_ammo_img, (100, 75))
special_ammo_img = pygame.image.load('img/drops/special_ammo.png').convert_alpha()
special_ammo_img = pygame.transform.scale(special_ammo_img, (110, 60))
    ...
    def __init__(self, char_type, x, y, scale, speed, ammo, laser):
        ...
        for animation in animation_types:
            ...
            for i in range(num_of_frames):
                img = pygame.image.load(f'img/{self.char_type}/{animation}/guy{i}.png').convert_alpha()
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, x, y, scale):
        ...
        for num in range(0,6):
            img = pygame.image.load(f'img/explosions/explosion{num}.png').convert_alpha()
...
while run:
    ...
    if start_game == False:
        ...
        if player.alive:
            ...
            screen_scroll = player.move(movl, movr)
